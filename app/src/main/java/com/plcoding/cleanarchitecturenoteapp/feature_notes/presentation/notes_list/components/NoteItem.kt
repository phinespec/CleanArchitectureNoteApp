...
import com.plcoding.cleanarchitecturenoteapp.feature_notes.domain.util.Preview.NoteItemPreviewParameterProvider
...
@Composable
fun NoteItemPreview(
    @PreviewParameter(NoteItemPreviewParameterProvider::class) note: Note
) {
    CleanArchitectureNoteAppTheme {
        NoteItem(note = note, onClickDelete = {})
    }
}